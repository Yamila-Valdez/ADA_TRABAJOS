...
//Si el usuario ingresa un color inválido, el programa debe mostrar un mensaje: "Color no reconocido, ingresa rojo, amarillo o verde." Utiliza un switch para resolver este ejercicio.

const prompt = require("prompt-sync")();

//Pedir color del semáforo al usuario
let color = prompt("Ingrese un color del semáforo (rojo, amarillo o verde): ").toLowerCase();

//Verificar color con switch
switch (color) {
    case "rojo":
